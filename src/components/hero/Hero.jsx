...
// // ==========================================================
// const Block = ({ scrollProgress, startX, endX, color, height, children }) => {
//   // Setiap balok membuat transformasinya sendiri
//   // Ini akan menggerakkan balok dari '0%' ke (speed)% secara horizontal
...
//       color: '#fff7ed',
//       height: '10%',
//       content: <h2>Navigasi Utama</h2>,
//     }, // Balok 1: Mulai di 0, berakhir di 50
//     { startX: 60, endX: 40, color: '#fff7ed', height: '10%', content: null }, // Balok 2: Mulai dari kiri, berakhir di -30
//     { startX: -60, endX: -40, color: '#fff7ed', height: '10%', content: null }, // Balok 3: Mulai di 30, berakhir di 80
//     { startX: -50, endX: -40, color: '#fff7ed', height: '10%', content: null }, // Balok 4: Mulai dari kiri
//     { startX: 40, endX: 65, color: '#fff7ed', height: '10%', content: null }, // Balok 5: Mulai di 0
//     { startX: -60, endX: -40, color: '#fff7ed', height: '10%', content: null }, // Balok 6: Mulai jauh dari kiri
//     { startX: 50, endX: 60, color: '#fff7ed', height: '10%', content: null }, // Balok 7: Mulai di 10, berakhir jauh di kanan
//     { startX: 30, endX: 20, color: '#fff7ed', height: '10%', content: null }, // Balok 8
//     { startX: 0, endX: 10, color: '#fff7ed', height: '5%', content: null }, // Balok 9
//     {
//       startX: -50,
//       endX: -60,
//       color: '#fff7ed',
...
//     { startX: 0, endX: 10, color: '#fff7ed', height: '5%', content: null }, // Balok 11: Mulai dari kanan, berakhir di kiri
//   ];
//   return (
//     <motion.div
//       variants={variants}
...
//             {/* Konten ditaruh di sini sebagai 'children' */}
//             {config.content}
//           </Block>
//         ))}
//       </motion.div>
