// // File: src/components/ChatToggleSidebar/ChatToggleSidebar.jsx

// import { motion } from 'framer-motion';
// import { useChat } from '../../context/ChatContext';
// import './ChatToggleSidebar.scss'; // Kita akan gunakan 1 file SCSS untuk semua

// export default function ChatToggleSidebar() {
//   const { isChatActive, setIsChatActive } = useChat();

//   // Jika chat sudah aktif, jangan tampilkan tombol ini
//   if (isChatActive) {
//     return null;
//   }
...
//       onClick={() => setIsChatActive(true)} // Mengaktifkan sesi chat
//       initial={{ x: 100 }}
//       animate={{ x: 0 }}
//       transition={{ delay: 0.5, type: 'spring', stiffness: 100, damping: 15 }}>
//       {/* Animasi "mantul" sesuai permintaan Anda */}
//       <motion.span
//         animate={{ x: [0, -5, 0] }}
//         transition={{
//           duration: 1.5,
